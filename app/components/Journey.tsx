          ...
          {STEPS.map((step) => (
            <div key={step.n} className="group">
              <div className="relative mb-5">
                ...
                <div className="relative z-10 w-full aspect-[9/19] rounded-[28px] border-[3px] border-slate-900 overflow-hidden shadow-lg transform transition-transform group-hover:-translate-y-2">
